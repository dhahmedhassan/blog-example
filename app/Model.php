...
class Model extends Elequent
{
    ...
    protected $guarded = ['user_id']; // these are the fields that you do not want to allow - blacklisted - // you can leave it empty and in this case you're not guarding anything.
}
